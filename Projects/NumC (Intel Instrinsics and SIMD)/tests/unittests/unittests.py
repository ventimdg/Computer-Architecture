...
class TestMul(TestCase):
    ...
    def test_mediumish_mul(self):
        # TODO: YOUR CODE HERE
        dp_mat1, nc_mat1 = rand_dp_nc_matrix(40, 50, seed=0)
        dp_mat2, nc_mat2 = rand_dp_nc_matrix(50, 40, seed=1)
        is_correct, speed_up = compute([dp_mat1, dp_mat2], [nc_mat1, nc_mat2], "mul")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
    ...
    def test_largeunsquare_mul(self):
        # TODO: YOUR CODE HERE
        dp_mat1, nc_mat1 = rand_dp_nc_matrix(920, 860, seed=0)
        dp_mat2, nc_mat2 = rand_dp_nc_matrix(860, 990, seed=1)
        is_correct, speed_up = compute([dp_mat1, dp_mat2], [nc_mat1, nc_mat2], "mul")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
...
class TestPow(TestCase):
    ...
    def test_medium_pow(self):
        dp_mat, nc_mat = rand_dp_nc_matrix(250, 250, seed=0)
